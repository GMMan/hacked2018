...
public class BluetoothLeService extends Service {
    ...
    private String mFoundBluetoothDeviceAddress;
    ...
    public void autoDetectSerialDevice() {
        final ScanCallback callback = new ScanCallback() {
            @Override
            public void onScanResult(int callbackType, ScanResult result) {
                BluetoothDevice dev = result.getDevice();
                if ("HMSoft".equals(dev.getName())) {
                    mFoundBluetoothDeviceAddress = dev.getAddress();
        ...
        mFoundBluetoothDeviceAddress = null;
        scanLeDevice(true, callback);
    }

    public String getFoundBluetoothDeviceAddress() {
        return mFoundBluetoothDeviceAddress;
    }
